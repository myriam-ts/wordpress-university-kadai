...
<footer class="footer">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_section footer_about">
                  <div class="footer_logo_container">
                    <img src="<?php echo MY_THEME_DIR_URI;?>/images/logo_big.png" alt="" />
                    <a href="">
              ...
              <div class="col-lg-3 footer_col">
                <div class="footer_section footer_links">
                  <div class="footer_links_container">
                    <ul>
                      <li><a href="<?php echo home_url(); ?>/news.html">ニュース</a></li>
                      <li><a href="<?php echo home_url(); ?>/events.html">イベント</a></li>
                      <li><a href="<?php echo home_url(); ?>/courses.html">コース</a></li>
  ...
  <!--jQuery-->
  <script src="<?php echo MY_THEME_DIR_URI;?>/js/jquery-3.2.1.min.js"></script>
  <script src="<?php echo MY_THEME_DIR_URI;?>/styles/bootstrap4/popper.js"></script>
  <script src="<?php echo MY_THEME_DIR_URI;?>/styles/bootstrap4/bootstrap.min.js"></script>
