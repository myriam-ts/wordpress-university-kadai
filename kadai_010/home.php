<?php get_header();?>
          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?php echo MY_THEME_DIR_URI;?>/images/top1_1200_630.jpg" class="d-block w-100" style="background-color: #2b7b8e26" />
                <div class="carousel-caption d-none d-md-block">
                  <img src="<?php echo MY_THEME_DIR_URI;?>/images/logo_big_slide.png" />
              ...
              <div class="carousel-item">
                <img src="<?php echo MY_THEME_DIR_URI;?>/images/top2_1200_630.jpg" class="d-block w-100" />
                <div class="carousel-caption d-none d-md-block">
                  <img src="<?php echo MY_THEME_DIR_URI;?>/images/logo_big_slide.png" />
                  <div class="title-slide">
                    <p>Samurai University</p>
              ...
              <div class="carousel-item">
                <img src="<?php echo MY_THEME_DIR_URI;?>/images/top3_1200_630.jpg" class="d-block w-100" />
                <div class="carousel-caption d-none d-md-block">
                  <img src="<?php echo MY_THEME_DIR_URI;?>/images/logo_big_slide.png" />
                  <div class="title-slide">
                    <p>Samurai University</p>
              ...
              <div class = "news_post_small">
                ...
                <div class = "col-lg-9 col-md-8 col-sx-12">
                  ...
                  <div class = "news_post_content">
                    <?php
                    $content = wp_trim_words (get_the_content(), 50, "<a href = <?php the_permalink();?> [続きを読む]</a>");
                    echo $content;
                    ?>
                  </div>
                </div>
      ...
      <div class="footer_row">
        ...
        <div class="row courses_row">
          <div class="col-lg-4 course_col">
            <div class="course">
              <div class="course_image">
                <img src="<?php echo MY_THEME_DIR_URI;?>/images/pic6-3.jpg" alt="" />
              </div>
          ...
          <div class="col-lg-4 course_col">
            <div class="course">
              <div class="course_image">
                <img src="<?php echo MY_THEME_DIR_URI;?>/images/pic6-4.jpg" alt="" />
              </div>
              <div class="course_body">
    ...
    <!-- 数字 -->
    <div class="counter">
      <div class="counter_background" style="background-image: url(<?php echo MY_THEME_DIR_URI;?>/images/pic_chart.png)"></div>
      <div class="footer_row">
        <div class="">
          <div class="">
              ...
              <div class="milestones row">
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>教授数</p>
                    <img src="<?php echo MY_THEME_DIR_URI;?>/images/icon4.png" alt="" />
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>卒業生徒</p>
                    <img src="<?php echo MY_THEME_DIR_URI;?>/images/icon3.png" alt="" />
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>学習コース</p>
                    <img src="<?php echo MY_THEME_DIR_URI;?>/images/icon2.png" alt="" />
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>受賞</p>
                    <img src="<?php echo MY_THEME_DIR_URI;?>/images/icon1.png" alt="" />
